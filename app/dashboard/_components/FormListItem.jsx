...
function FormListItem({ jsonForm, formRecord, refreshData }) {
    console.log("Received jsonForm in FormListItem:", jsonForm);
    ...
    return (
        <div className='text-white border shadow-sm rounded-lg p-4'>
            <div className='flex justify-between'>
                <h2></h2>

                <AlertDialog>
                    <AlertDialogTrigger>  <Trash className='h-5 w-5 text-red-600 cursor-pointer hover:scale-105 transition-all'
            ...
            <div className='flex justify-between'>
                ...
                >
                    <Button size="sm" className="flex gap-2 bg-green-400 hover:bg-green-600"><Share className='h-5 w-5' />Share</Button>
                </RWebShare>
